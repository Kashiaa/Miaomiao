...
WebUI.waitForElementPresent(findTestObject('Page_CURA Healthcare Service/input_Demo account_form-control'), 15)
...
WebUI.waitForElementPresent(findTestObject('Page_CURA Healthcare Service/button_Login'), 15)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'qsd')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.waitForElementPresent(findTestObject('Page_CURA Healthcare Service/a_Go to Homepage'), 15)
